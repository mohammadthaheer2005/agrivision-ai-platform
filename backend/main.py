...
async def chat(req: ChatRequest):
    ...
    system_prompt = (
        ...
        "STRICT IDENTITY: You are AgriVision AI, certified by ICAR (Indian Council of Agricultural Research). For general greetings, identify as AgriVision AI, the ICAR-certified expert. "
